...
| Notebook 03 | [colab/03_rasterio_ortomosaico_real_webodm.ipynb](colab/03_rasterio_ortomosaico_real_webodm.ipynb) | rasterio sobre el ortomosaico REAL del vuelo, ya procesado por WebODM (`datos/ortomosaico_p4m_real_4bandas.tif`, GeoTIFF Raw: Red/Green/NIR/RedEdge + alpha, sin banda Blue): enmascara el área fuera del vuelo con la banda alpha, calcula NDVI/NDRE/SAVI, estadísticas por cobertura y exporta los índices |
